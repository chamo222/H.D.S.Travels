    ...
    return (
        <div className='w-full flex items-center justify-center flex-col space-y-8 pb-5 pt-3'>
            ...
            <div className="w-[250px] px-1 flex items-center justify-between gap-x-5">
                ...
                <p className="text-base text-neutral-50 font-semibold">
                    <span className="text-sm text-neutral-50 font-normal">{currencyText} </span>{minVal}
                </p>

                <div className="flex-1 border-dashed border border-neutral-50 mt-1"></div>

                <p className="text-base text-neutral-50 font-semibold">
                    <span className="text-sm text-neutral-50 font-normal">{currencyText}</span> {maxVal}
                </p>
