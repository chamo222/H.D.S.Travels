...
import { FaBus } from "react-icons/fa"; // ⬅ added bus icon
    ...
    <div className="min-h-screen bg-black text-white px-6 py-16 space-y-12">
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center h-screen space-y-6">
          ...
          />
          <FaBus className="text-purple-400 text-5xl animate-bounce" /> {/* 🚌 bus icon */}
        ...
        <>
          ...
          >
            ...
            {message && (
              <p className="text-center text-yellow-400 font-medium mt-2">
                {message}
              </p>
            )}
          </motion.div>
          ...
          <motion.div
            ...
            variants={fadeIn("up")}
          >
            ⚠ Only admin users can access this page. Ensure you select the
        ...
        {users.map((user) => (
          <tr key={user.id} className="hover:bg-gray-800">
            ...
            <td className="px-4 py-2 flex items-center gap-2">
              ...
              {(roleColor === "yellow" || roleColor === "purple") &&
                removeRole && (
                  <button
